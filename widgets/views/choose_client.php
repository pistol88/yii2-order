...
<div class="choose-client row">
    <div class="col-md-12">
		...
		<div class="row">
			...
			<div class="col-md-8"><p><?=Html::a('<i class="glyphicon glyphicon-search"></i> Найти покупателя', '#usersModal', ['id' => 'choose-user-id', 'data-toggle' => "modal", 'data-target' => "#usersModal"]);?></a></p></div>
		</div>
