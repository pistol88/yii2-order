Внимание!
==========
Разработка модуля с 204.04.2017 ведется здесь: [dvizh/yii2-order](https://github.com/dvizh/yii2-order). Рекомендую устанавливать модуль из репозиторий Dvizh, именно там находится последняя версия.
